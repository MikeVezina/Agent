...
public class Krislet implements SendCommand {
    ...
    private static Krislet singletonInstance;
    ...
    public static void main(String a[]) throws SocketException, IOException {
        ...
        Krislet.singletonInstance = new Krislet(InetAddress.getByName(hostName), port, team, strategy);

        // enter main loop
        singletonInstance.mainLoop();
    }
    ...
    public Krislet(InetAddress host, int port, String team, String strategy) throws SocketException {
    ...
    public static Krislet getInstance() {
    ...
    //===========================================================================
    // Implementation of krislet.SendCommand Interface
    ...
    protected void parseInitCommand(String message)
        ...
        char m_side = m.group(1).charAt(0);
